package com.mustang.lib_common.view;
...
public class LoadingIndicatorView extends View {
    ...
    public LoadingIndicatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, com.wang.avi.R.style.AVLoadingIndicatorView);
    }

    public LoadingIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, com.wang.avi.R.style.AVLoadingIndicatorView);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, com.wang.avi.R.styleable.AVLoadingIndicatorView, defStyleAttr, defStyleRes);

        mMinWidth = a.getDimensionPixelSize(com.wang.avi.R.styleable.AVLoadingIndicatorView_minWidth, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(com.wang.avi.R.styleable.AVLoadingIndicatorView_maxWidth, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(com.wang.avi.R.styleable.AVLoadingIndicatorView_minHeight, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(com.wang.avi.R.styleable.AVLoadingIndicatorView_maxHeight, mMaxHeight);
        String indicatorName = a.getString(com.wang.avi.R.styleable.AVLoadingIndicatorView_indicatorName);
        mIndicatorColor = a.getColor(com.wang.avi.R.styleable.AVLoadingIndicatorView_indicatorColor, Color.parseColor("#FFDBB866"));
    ...
    public void show() {
        ...
        if (!mPostedShow) {
            new Handler().postDelayed(mDelayedShow, MIN_DELAY);
