...
public abstract class RootFragment<T extends BasePresenter> extends BaseFragment<T> {
    ...
    private RootFragment.PermissionsResultListener mListener;
     ...
     */
    protected void performRequestPermissions(String desc, String[] permissions, int requestCode, RootFragment.PermissionsResultListener listener) {
